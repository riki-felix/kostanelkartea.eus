...
/* template.twig */
class __TwigTemplate_ee25b8cb646fcd7e1910b52a86e1f19cc69bcb56cd0baa3b87b705645feb505c extends \WPML\Core\Twig\Template
{
...
\t\t\t<a href=\"#\" hreflang=\"";
        ...
        echo "\"";
        if ($this->getAttribute(($context["language"] ?? null), "is_current", [])) {
            echo "  aria-current=\"page\"";
        }
        echo " aria-expanded=\"false\" aria-controls=\"wpml-ls-submenu-click-";
        echo \WPML\Core\twig_escape_filter($this->env, (($this->getAttribute(($context["backward_compatibility"] ?? null), "css_id", [], "any", true, true)) ? (\WPML\Core\_twig_default_filter($this->getAttribute(($context["backward_compatibility"] ?? null), "css_id", []), "default")) : ("default")), "html", null, true);
        echo "\" aria-haspopup=\"true\" aria-label=\"";
        echo \WPML\Core\twig_escape_filter($this->env, ($context["dropdown_click_ls_aria_label"] ?? null), "html", null, true);
        echo "\" tabindex=\"0\" role=\"button\" title=\"";
...
\t\t\t<ul id=\"wpml-ls-submenu-click-";
        // line 21
        echo \WPML\Core\twig_escape_filter($this->env, (($this->getAttribute(($context["backward_compatibility"] ?? null), "css_id", [], "any", true, true)) ? (\WPML\Core\_twig_default_filter($this->getAttribute(($context["backward_compatibility"] ?? null), "css_id", []), "default")) : ("default")), "html", null, true);
        echo "\" class=\"js-wpml-ls-sub-menu wpml-ls-sub-menu\">
\t\t\t\t";
        // line 22
...
";
    ...
    {
        return array (  182 => 42,  169 => 38,  166 => 36,  160 => 35,  158 => 34,  152 => 33,  148 => 32,  146 => 31,  139 => 29,  137 => 28,  135 => 26,  121 => 25,  117 => 24,  114 => 23,  103 => 22,  99 => 21,  95 => 19,  88 => 17,  86 => 16,  84 => 15,  82 => 13,  64 => 12,  59 => 10,  45 => 7,  42 => 6,  40 => 5,  38 => 4,  36 => 3,  34 => 2,  32 => 1,);
    }
    ...
    {
        return new Source("", "template.twig", "/www/kinsta/public/kostan-elkartea/wp-content/plugins/sitepress-multilingual-cms/templates/language-switchers/legacy-dropdown-click/template.twig");
    }
}
